    ...
    render() { 
        ...
        <div className="row">
            ...
            <div>
                ...
                <div className="row">
                    <div className="card mx-2 my-2" id="day-1">
                    ...
                    <div className="card mx-2 my-2" id="day-2">
                    ...
                    <div className="card mx-2 my-2" id="day-3">
                    ...
                    <div className="card mx-2 my-2" id="day-4">
                    ...
                    <div className="card mx-2 my-2" id="day-5">
